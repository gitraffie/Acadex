...
<head>
    ...
    <link rel="stylesheet" href="../css/auth/student-login.css">
    <style>
        .login-btn {
            display: inline-flex;
            align-items: center;
...
<body>
    <div class="login-container">
        <div class="login-left">
            <div class="left-content">
                ...
                <div class="welcome-icon"><img src="../image/student.webp" alt="Acadex Logo"></div>
        ...
        <div class="login-right">
            ...
            <form id="loginForm" action="../includes/login.php" method="POST">
                ...
                <div class="form-options">
                    ...
                    <a href="student-forgot-password.php" class="forgot-password">Forgot Password?</a>
                </div>
    ...
    <script>
        ...
        // Add enter key support: toggle the submit button and trigger submit
        const submitBtn = loginForm.querySelector('.login-btn');
        document.querySelectorAll('input').forEach(input => {
            input.addEventListener('keydown', function(e) {
                if (e.key === 'Enter') {
                    e.preventDefault();
                    submitBtn.classList.toggle('is-toggled');
                    submitBtn.setAttribute(
                        'aria-pressed',
                        submitBtn.classList.contains('is-toggled') ? 'true' : 'false'
                    );
                    submitBtn.click();
                }
            });
